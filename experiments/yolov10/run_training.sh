...
# 
# 示例:
#   ./run_training.sh configs/yolov10n_dairv2x.yaml
#   ./run_training.sh configs/yolov10s_dairv2x.yaml --epochs 100
#   ./run_training.sh configs/yolov10n_dairv2x.yaml --batch_size 48
#   ./run_training.sh configs/yolov10n_dairv2x.yaml --resume  # 自动从最新检查点恢复
#   ./run_training.sh configs/yolov10n_dairv2x.yaml --resume_from_checkpoint logs/yolo_v10n_20240101_120000/weights/best.pt

# 默认配置文件
CONFIG_FILE=${1:-configs/yolov10n_dairv2x.yaml}
