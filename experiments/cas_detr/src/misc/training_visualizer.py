...
class TrainingVisualizer:
    ...
    def _plot_cas_detr(self) -> None:
        ...
        plt.tight_layout()
        plt.savefig(self.log_dir / 'cas_detr_main_curves.png', dpi=150, bbox_inches='tight')
        plt.close()
        ...
        if len(self.history['detection_loss']) > 0 and max(self.history['detection_loss']) > 0:
            ...
            plt.tight_layout()
            plt.savefig(self.log_dir / 'cas_detr_loss_breakdown.png', dpi=150, bbox_inches='tight')
            plt.close()
