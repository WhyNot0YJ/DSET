...
# 
# 示例:
#   ./run_training.sh configs/moe6_r18.yaml
#   ./run_training.sh configs/moe6_r18.yaml --epochs 100
#   ./run_training.sh configs/moe6_r18.yaml --top_k 2
#   ./run_training.sh configs/moe6_r18.yaml --resume  # 自动从最新检查点恢复
#   ./run_training.sh configs/moe6_r18.yaml --resume_from_checkpoint logs/moe6_rtdetr_r18_20240101_120000/latest_checkpoint.pth

# 默认配置文件 (6专家 + PResNet18)
CONFIG_FILE=${1:-configs/moe6_r18.yaml}
